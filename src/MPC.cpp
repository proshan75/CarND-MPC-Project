...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        //std::cout << "--------- Initial constraints setup done............ " << std::endl;
        ...
        for (size_t t = 1; t < N; t++) {
            ...
            //std::cout << "psi0 " << psi0 << " psi1 " << psi1 << std::endl;
            ...
            //std::cout << "cte0 " << cte0 << " cte1 " << cte1 << std::endl;

            AD<double> epsi1 = vars[epsi_start + t];
            AD<double> epsi0 = vars[epsi_start + t - 1];
            //std::cout << "epsi0 " << epsi0 << " epsi1 " << epsi1 << std::endl;
            ...
            //std::cout << " .... 1 + x_start + t: " << 1 + x_start + t << std::endl;
            fg[1 + x_start + t] = x1 - (x0 + v0 * CppAD::cos(psi0) * dt);
            //std::cout << " fg[1 + x_start + t] " << fg[1 + x_start + t] << " at t: " << t << std::endl;
...
std::vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
    ...
    //std::cout << "solution.x[delta_start]: " << solution.x[delta_start] << " solution.x[a_start]: " << solution.x[a_start] << std::endl;
